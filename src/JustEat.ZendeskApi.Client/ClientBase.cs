...
using HttpChannel = JustEat.ZendeskApi.Client.Http.HttpChannel;
using HttpRequest = JustEat.ZendeskApi.Client.Http.HttpRequest;
using IHttpRequest = JustEat.ZendeskApi.Client.Http.IHttpRequest;
using IHttpResponse = JustEat.ZendeskApi.Client.Http.IHttpResponse;
using ILogAdapter = JustEat.ZendeskApi.Client.Logging.ILogAdapter;
using IRestClient = JustEat.ZendeskApi.Client.Http.IRestClient;
