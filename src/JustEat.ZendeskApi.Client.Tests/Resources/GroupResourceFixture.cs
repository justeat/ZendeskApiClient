...
namespace JustEat.ZendeskApi.Client.Tests.Resources
{
    public class GroupResourceFixture
    {
        ...
        {
            // Given
            _client.Setup(b => b.BuildZendeskUri(It.IsAny<string>(), It.Is<string>(s => s.Contains("321")))).Returns(new Uri("http://zendesk"));
            ...
            // Then
            _client.Verify(c => c.BuildZendeskUri(It.Is<string>(s => s.Contains("/groups/321")), ""));
        }
