...
{
    internal class UpdateOrganizationOperation : IUpdateOrganizationOperation
    {
        [JsonProperty("id")]
        public long Id { get; }
        ...
        public UpdateOrganizationOperation(IUpdateOrganizationOperation createOrganizationOperation)
        {
