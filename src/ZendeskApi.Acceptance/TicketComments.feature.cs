...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "TicketComments", "In order to manage issues\nAs an api comsumer\nI want to be able to get, getall, pu" +
                    "t, post and delete ticketcomments", ProgrammingLanguage.CSharp, ((string[])(null)));
...
#line 31
 testRunner.When("I call get all comments for that ticket", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 32
 testRunner.Then("I am returned a comment that is made via the api", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            this.ScenarioCleanup();
        }
    }
